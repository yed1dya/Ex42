...
public final class StdDraw_Ex4 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static void init() {
		...
		getFrame().setTitle("Ex4 I2CS (Ariel) Demo Solution V0.1 (uses Standard Draw)");
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			...
			if(b==1) {
				_ex4.mouseClicked(new Point_2D(mouseX, mouseY));
			}
			if(b==3) {
				_ex4.mouseRightClicked(new Point_2D(mouseX, mouseY));
			}
